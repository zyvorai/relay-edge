...
- Put real TLS at Ingress or via `tls.existingSecret` — do not ship lab self-signed certs to users
...
- See [docs/PRODUCTION.md](docs/PRODUCTION.md) for the full user checklist
