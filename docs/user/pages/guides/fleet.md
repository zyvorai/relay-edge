...
Multi-class IoT scenarios: blackout, amr_lost, ot_storm, spill, heatwave, intrusion.

## When to use it

- Open **Fleet** when the job matches this screen
- Prefer the product home / Get started panel if you are unsure where to begin
- Confirm health and auth tokens if probes fail

## How to get there

- UI path: `/ui/` → **Fleet** (or matching nav tab)
...
2. Navigate to **Fleet**.
3. Complete the on-screen fields / actions for this surface (Multi-class IoT scenarios: blackout, amr_lost, ot_storm, spill, heatwave, intrusion.).
